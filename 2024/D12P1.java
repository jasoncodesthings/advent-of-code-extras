...
public class D12P1{
  ...
  public static int findRegion(ArrayList<StringBuilder> map, int row, int column){

  }

  public static void main(String[]args){
    System.out.println(trailheadCountAdvanced("inputD12.txt"));
  }
}
*/
...
class Puzzle {
    ...
    Puzzle() throws IOException {
        try (var input = Objects.requireNonNull(getClass().getResourceAsStream("inputD12.txt"))) {
